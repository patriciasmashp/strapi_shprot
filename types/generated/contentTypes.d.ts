...
export interface ApiAdminAdmin extends Struct.SingleTypeSchema {
  ...
  attributes: {
    admins_id: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiBotSettingsBotSettings extends Struct.SingleTypeSchema {
  ...
  info: {
    description: '';
    displayName: '\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u0431\u043E\u0442\u0430';
    pluralName: 'bots-settings';
    singularName: 'bot-settings';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiBotTextBotText extends Struct.SingleTypeSchema {
  collectionName: 'bot_texts';
  info: {
    description: '';
    displayName: '\u0422\u0435\u043A\u0441\u0442\u044B \u0434\u043B\u044F \u0431\u043E\u0442\u0430';
    pluralName: 'bot-texts';
    singularName: 'bot-text';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    favorites_by_date: Schema.Attribute.Component<'api.izbrannoe', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiInstagramTokenInstagramToken
  extends Struct.SingleTypeSchema {
  collectionName: 'instagram_tokens';
  info: {
    displayName: '\u0422\u043E\u043A\u0435\u043D \u0438\u043D\u0441\u0442\u0430\u0433\u0440\u0430\u043C\u0430';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expire: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMasterMaster extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    about_master: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    is_blocked: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    is_notifications_allowed: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    master_url: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    profile_image: Schema.Attribute.Media<'files' | 'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    shareCount: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    styles: Schema.Attribute.Relation<'oneToMany', 'api::styles.styles'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
    ...
    validated: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiRequestRequest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.DefaultTo<'\u0417\u0432\u043E\u043D\u043E\u043A'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStylesStyles extends Struct.CollectionTypeSchema {
  collectionName: 'styleses';
  info: {
    displayName: '\u0421\u0442\u0438\u043B\u0438';
    pluralName: 'styleses';
    singularName: 'styles';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::styles.styles'>;
    publishedAt: Schema.Attribute.DateTime;
    style_name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
